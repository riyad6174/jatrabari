...
export const teachers: Teacher[] = [
  ...
  {
    id: 4,
    name: 'Mr Lutfar Zaman',
    designation: 'Assistant Teacher',
    department: 'General Knowledge',
    imageId: 'teacher-4',
    bio: 'Mr Lutfar Zaman broadens the horizons of his students by teaching them about the world. His classes are filled with interesting facts and discussions that encourage curiosity and a love for learning.',
  },
  {
    id: 5,
    name: 'Mrs. Rima Akter',
    ...
    department: 'Bangla',
    imageId: 'teacher-5',
    bio: 'Mrs. Rima Akter is an expert in Bangla language and grammar. She fosters a love for our mother tongue through engaging stories, poems, and interactive activities, ensuring students develop strong communication skills.',
  },
  {
    id: 6,
...
export const notices: Notice[] = [
  ...
  },
  {
    ...
    date: '2026-02-12',
    content:
      'We are excited to announce the annual school picnic for students of all classes, to be held at a nearby park. Registrations are now open. Interested parents can register their children with the school office by February 12th. The picnic is a great opportunity for students to socialize and have fun outside the classroom. The day will be filled with games, a healthy lunch, and lots of fun activities. The fee for the picnic is BDT 500 per student, which covers transportation, food, and entry fees. More details about the venue and date will be shared soon.',
  },
  {
    id: 3,
    ...
    date: '2025-06-25',
    content:
      'The school will remain closed for summer vacation from August 1st to June 25th. The school office will remain open on weekdays from 10:00 AM to 2:00 PM for any administrative work. We wish all our students a happy and restful vacation. We encourage students to engage in reading and other creative activities during the break. The school will reopen on July 16th with the regular schedule. Enjoy your holidays!',
  },
  {
    id: 4,
